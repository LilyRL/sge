...
//! be used in situations where sge_persistence is necessary (e.g. when the curve itself must be stored
//! for later use).
//!
...
// sge_vectors::curve re-exports all commonly-needed curve-related items.
pub use adaptors::*;
pub use easing::*;
